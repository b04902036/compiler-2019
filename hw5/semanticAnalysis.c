...
void checkWriteFunction(AST_NODE* functionCallNode);    //  added
void checkReadFunction(AST_NODE* functionCallNode);     //  added
void checkfReadFunction(AST_NODE* functionCallNode);    //  added
...
void checkWriteFunction(AST_NODE* functionCallNode)
{
	...
	if(param->nodeType == CONST_VALUE_NODE){
		param->dataType = CONST_STRING_TYPE;
	}
}
